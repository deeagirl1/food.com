...
<div class="wrapper">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-items">
          <li><a href="index.php?page=myaccount"><i class="fas fa-user-circle"></i>My Account</a></li>
          <br>
          <li><a href="index.php?page=shoppingcart"><i class="fas fa-shopping-cart"></i>Shopping Cart</a></li>
          <br>
            ...
            if(isset($_GET['page']))
            {
                switch ($_GET['page']) {
                    case 'myaccount':
                        ...
                        break;
                    case 'shoppingcart':
                        $requestedPage = 'views/shoppingcart.php';
                        break; 
                    case 'orders':
